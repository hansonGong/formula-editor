...
import { injectMathJax, setMathJaxConfig } from '../mathjax'
...
class Editor {
  ...
  /**
   * 加载并初始化 mathJax
   * @param onReady mathJax加载完成
   */
  public initMathJax(onReady: FnType): void {
    injectMathJax(this.config.mathJaxUrl)
    setMathJaxConfig(onReady)
  }
